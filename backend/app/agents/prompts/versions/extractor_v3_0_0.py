"""
EXTRACTOR Agent Prompt - Version 3.0.0

BREAKING CHANGE: Content-first extraction replacing schema-first approach.
Preserves ALL page structure from Vision API, adds light interpretation hints.
"""
