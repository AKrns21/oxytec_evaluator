"""
EXTRACTOR Agent Prompt - Version 2.0.0

Major refactoring to focus on pure technical extraction, removing business logic.
"""
...
- "extraction_notes" MUST be populated for any missing, unclear, or ambiguous data
...
{{
  ...
  "extraction_notes": [
    {{
      ...
      "note": "Document states 'Oxygen content not measured'"
    }},
    {{
    ...
    {{
      ...
      "status": "missing_in_source",
      "note": "Ethyl acetate mentioned without CAS number"
    }}
  ],
  "data_quality_issues": [],
  "customer_specific_questions": []
...
This example shows: (1) correct Unicode → ASCII unit normalization (m³/h → m3/h, °C → degC), (2) extraction of optional fields when available (pressure, humidity), (3) mixed format handling (both m³/h and m3/h normalized to m3/h), (4) null for missing numbers, (5) extraction_notes for flagging missing data without severity assessment.
