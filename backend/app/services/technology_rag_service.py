...
class TechnologyRAGService:
    ...
    async def search_knowledge(
        ...
        try:
            ...
            logger.error("technology_search_failed", query=query, error=str(e))
            raise
    ...
    async def get_knowledge_by_page(self, page_number: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("knowledge_by_page_failed", page_number=page_number, error=str(e))
            raise
    ...
    async def get_technologies_by_pollutant(self, pollutant: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("technologies_by_pollutant_failed", pollutant=pollutant, error=str(e))
            raise
    ...
    async def get_application_examples(
        ...
        try:
            ...
            logger.error("application_examples_failed", error=str(e))
            raise
